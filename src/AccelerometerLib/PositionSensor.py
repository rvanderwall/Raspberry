...
def main():
    ...
    while True:
        ...
        print("gyro data")
        print("------------")
        (gyro_xout, gyro_yout, gyro_zout) = sensor.get_gyro()
        ...
        print("-------------------------")
        (accel_xout, accel_yout, accel_zout) = sensor.get_position()
        print("accel_xout:{0}".format(accel_xout))
        print("accel_yout:{0}".format(accel_yout))
        print("accel_zout:{0}".format(accel_zout))

        x_rotation = sensor.get_x_rotation()
        y_rotation = sensor.get_y_rotation()
